...
window.VERALIQ_PORTAL_I18N = {
  ...
  dict: {
    tr: {
      ...
      "agentWidget.micBlocked":"Mikrofon izni verilmedi. Asistan sizi duyamıyor — tarayıcı ayarlarından mikrofon iznini açıp sayfayı yenileyin.",
    ...
    en: {
      ...
      "agentWidget.micBlocked":"Microphone access wasn't granted. The assistant can't hear you — enable microphone permission in your browser settings and reload the page.",
    ...
    ru: {
      ...
      "agentWidget.micBlocked":"Доступ к микрофону не предоставлен. Ассистент вас не слышит — включите доступ в настройках браузера и обновите страницу.",
